...
async function requestSubscribeMessage(event) {
   ...
   return '0dp36zT0PH_Kho6I3lUkDiOtqIT5nlNRhMeFmIABhkA'
}
...
async function sendSubscribeMessage(event) {
   ...
   const {
      templateId
   } = '0dp36zT0PH_Kho6I3lUkDiOtqIT5nlNRhMeFmIABhkA'

   const sendResult = await cloud.openapi.subscribeMessage.send({
      touser: OPENID,
      templateId: '0dp36zT0PH_Kho6I3lUkDiOtqIT5nlNRhMeFmIABhkA',
      ...
      data: {
         ...
         "date3": {
            value: new Date().toDateString() + "  " + new Date().toTimeString()
         },
      }
   })
